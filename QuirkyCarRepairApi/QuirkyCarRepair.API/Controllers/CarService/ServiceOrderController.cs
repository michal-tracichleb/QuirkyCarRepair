...
namespace QuirkyCarRepair.API.Controllers.CarService
{
    ...
    public class ServiceOrderController : ControllerBase
    {
        ...
        // GET: api/CarService/<ServiceOrderController>
        [HttpGet]
        ...
        // GET api/CarService/<ServiceOrderController>/5
        [HttpGet("{id}")]
        ...
        // POST api/CarService/<ServiceOrderController>
        [HttpPost]
        ...
        // PUT api/CarService/<ServiceOrderController>/5
        [HttpPut("{id}")]
        ...
        // DELETE api/CarService/<ServiceOrderController>/5
        [HttpDelete("{id}")]
